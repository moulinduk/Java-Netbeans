...
public class Sum extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String str;
        int sum = 0, num, count = 0, reply;
        do
        {
            str = JOptionPane.showInputDialog(null, "Enter Number");
            num = (int) Double.parseDouble(str);
            jTextArea1.append(num+"\n");
            sum = num + sum;
            count = count+1;
            reply = JOptionPane.showConfirmDialog(null, "Add more Numbers?","Enter Numbers", JOptionPane.YES_NO_OPTION);
            
        }
        while (reply == JOptionPane.YES_OPTION);
        jTextArea1.append("Count of Numbers = "+count+"\nSum of Numbers = "+sum);
